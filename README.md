...
This app let to admin batch queries to stackoverflow and persist the result in parquet files
Readme base of JHipster:
# etlBigdata
...
To optimize the etlBigdata application for production, run:
